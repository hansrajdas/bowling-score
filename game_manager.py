...
class GameManager(object):
    ...
    def updateScore(self, currentFrame, roll):
        ...
        Args:
          ...
          roll: Roll count, 0 or 1. Can be 2 also but only when currentFrame is
            9.
        """
        ...
        # rolls made.
        if currentFrame == constants.TOTAL_FRAMES - 1 and (roll == 2):
            frameData['score'] = sum(
              frameData['roll'][r] for r in frameData['roll'])
